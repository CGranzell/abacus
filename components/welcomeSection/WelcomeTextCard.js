    ...
    <div className={styles.mainContainer}>
      ...
      <div className={styles.textWrapper}>
        ...
        <p>
          ...
          matematik, teknik och naturvetenskap finns idag alltför få utmaningar. <br/>
          ...
          utanförskap. <br/> Forskning visar att många talangfulla elever
          underpresterar för att passa in i den svenska skolan (Sims 2021). <br/> Vi
